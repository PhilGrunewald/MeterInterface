...
def boxplot(graph):
    ...
    plt.xlabel(graph["xLabel"])
    plt.ylabel(graph["yLabel"])
    # plt.savefig('Electricity_graph.png')
    plt.savefig('ElectricityProfile.png', transparent=True)
    plt.show()
...
def main():
  ...
  # boxplot(TUC_Watt)
  # boxplot(Enjoy_Watt)
  # boxplot(Location_Watt)
  boxplot(Electricity_graph)
# ========= #
#  EXECUTE  #
# ========= #
